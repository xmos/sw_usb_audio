...
This release is built and tested using version 13.2 of the XMOS tool set.  Build or functionality issues could be experienced with any other version.
