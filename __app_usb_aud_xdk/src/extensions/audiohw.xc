...
#define CODEC_REGREAD_ASSERT(reg, data, expected)  {data[0] = 0xAA; i2c_master_read_reg(COD_DEV_ADRS, reg, data, 1, i2cPorts); assert(data[0] == expected);}
...
void AudioHwInit(chanend ?c_codec)
{
    ...
    CODEC_REGREAD_ASSERT(0x2, tmp, 0x1);
