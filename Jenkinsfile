              ...
              dir("tests") {
                ...
                withTools("${env.TOOLS_VERSION}") {
                  withVenv() {
                    ...
                    withXTAG(["usb_audio_mc_xcai_dut", "usb_audio_mc_xcai_harness"]) { xtagIds ->
                      sh "pytest -k \"midi\" -s -v --level ${params.TEST_LEVEL} --junitxml=pytest_result_windows10.xml \
                          -o xk_316_mc_dut=${xtagIds[0]} -o xk_316_mc_harness=${xtagIds[1]}"
                    }
                  }
                }
              ...
              dir("tests") {
                ...
                withTools("${env.TOOLS_VERSION}") {
                  withVenv() {
                    ...
                    withXTAG(["usb_audio_mc_xcai_dut", "usb_audio_mc_xcai_harness"]) { xtagIds ->
                      sh "pytest -k \"midi\" -s -v --level ${params.TEST_LEVEL} --junitxml=pytest_result_windows11.xml \
                          -o xk_316_mc_dut=${xtagIds[0]} -o xk_316_mc_harness=${xtagIds[1]}"
                    }
                  }
                }
