...
set(APP_COMPILER_FLAGS_2AMi32o32xxxxxx_tdm8_mix8_hibw ${SW_USB_AUDIO_FLAGS} -DNUM_USB_CHAN_IN=32 -DNUM_USB_CHAN_OUT=32 -DI2S_CHANS_ADC=32 -DI2S_CHANS_DAC=32 -DXUD_USB_ISO_MAX_TXNS_PER_MICROFRAME=2 -DMAX_FREQ=96000 -DXUA_PCM_FORMAT=XUA_PCM_FORMAT_TDM -DMAX_MIX_COUNT=8)
...
set(APP_COMPILER_FLAGS_2AMi24o24xxxxxx_tdm8_mix8_hibw ${SW_USB_AUDIO_FLAGS} -DNUM_USB_CHAN_IN=24 -DNUM_USB_CHAN_OUT=24 -DI2S_CHANS_ADC=24 -DI2S_CHANS_DAC=24 -DXUD_USB_ISO_MAX_TXNS_PER_MICROFRAME=2 -DMAX_FREQ=96000 -DXUA_PCM_FORMAT=XUA_PCM_FORMAT_TDM -DMAX_MIX_COUNT=8)
set(APP_COMPILER_FLAGS_2AMi32o32xxxxxx_tdm8_hibw ${SW_USB_AUDIO_FLAGS} -DNUM_USB_CHAN_IN=32 -DNUM_USB_CHAN_OUT=32 -DI2S_CHANS_ADC=32 -DI2S_CHANS_DAC=32 -DXUD_USB_ISO_MAX_TXNS_PER_MICROFRAME=2 -DMAX_FREQ=96000 -DXUA_PCM_FORMAT=XUA_PCM_FORMAT_TDM)
endif()

if(BUILD_TESTED_CONFIGS)
set(APP_COMPILER_FLAGS_2AMi30o30xxxxxx_usblb_hibw ${SW_USB_AUDIO_FLAGS} -DNUM_USB_CHAN_IN=30 -DNUM_USB_CHAN_OUT=30 -DXUD_USB_ISO_MAX_TXNS_PER_MICROFRAME=2 -DUSB_LOOPBACK=1 -DUAC_FORCE_FEEDBACK_EP=0 -DXUD_NAK_ISO_OUT -D_XUD_NAK_ISO_IN -DMAX_FREQ=96000)
endif()
