...
#define ACCESSORY_MODEL_NUMBER      "XR-IOS-USB-AUDIO-MC"
...
/* Define for enabling audio input, in descriptors, buffering etc */
...
/* Define for enabling device audio, in descriptors, buffering etc */
...
/* Define to enable iAP audio accessory authentication.  */
...
/* Define to Enable DFU interface, Note, requires a driver for Windows */
...
/* Defines relating to channel count and channel arrangement */ 
/* Number of USB streaming channels */
#define NUM_USB_CHAN_IN             (10)               /* Host to device (D/A) */
#define NUM_USB_CHAN_OUT            (10)               /* Device to host (A/D) */
