...
or full-speed). Based on the `XMOS` `xcore-200` (XS2) and `xcore.ai` (XS3) architectures, it
supports USB Audio Class 2.0 and USB Audio Class 1.0, asynchronous mode (synchronous as an option)
and sample rates up to 384kHz.
