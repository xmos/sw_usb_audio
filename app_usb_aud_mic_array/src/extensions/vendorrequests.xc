    ...
    switch (direction) {
        case USB_BM_REQTYPE_DIRECTION_H2D: //0 = SET
             ...
             if (result == XUD_RES_OKAY) {
                 control_process_usb_ep0_set_request(sp.wIndex, sp.wValue, request_data_length, request_data, i_modules, 1);
        ...
        case USB_BM_REQTYPE_DIRECTION_D2H: //1 = GET
            /* application retrieval latency inside the control library call
                 ...
                 */
            size_t len;
            control_process_usb_ep0_get_request(sp.wIndex, sp.wValue, len, request_data, i_modules, 1);
