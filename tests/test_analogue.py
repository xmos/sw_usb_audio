...
@pytest.mark.parametrize(["board", "config"], list_configs())
def test_analogue_loopback_run_00(pytestconfig, board, config):
    features = get_config_features(board, config)
...
@pytest.mark.uncollect_if(func=analogue_loopback_uncollect)
@pytest.mark.parametrize(["board", "config"], list_configs())
def test_analogue_loopback_run_01(pytestconfig, board, config):
    features = get_config_features(board, config)
...
@pytest.mark.uncollect_if(func=analogue_loopback_uncollect)
@pytest.mark.parametrize(["board", "config"], list_configs())
def test_analogue_loopback_run_02(pytestconfig, board, config):
    features = get_config_features(board, config)
...
@pytest.mark.uncollect_if(func=analogue_loopback_uncollect)
@pytest.mark.parametrize(["board", "config"], list_configs())
def test_analogue_loopback_run_03(pytestconfig, board, config):
    features = get_config_features(board, config)
...
@pytest.mark.uncollect_if(func=analogue_loopback_uncollect)
@pytest.mark.parametrize(["board", "config"], list_configs())
def test_analogue_loopback_run_04(pytestconfig, board, config):
    features = get_config_features(board, config)
...
@pytest.mark.uncollect_if(func=analogue_loopback_uncollect)
@pytest.mark.parametrize(["board", "config"], list_configs())
def test_analogue_loopback_run_05(pytestconfig, board, config):
    features = get_config_features(board, config)
